...
public class BinaryTreeTasks {
    ...
    public static int subtract\_sum(TreeNode root) {
    ...
    public static void swap\_child(TreeNode root, int level, int M) {
        ...
        swap\_child(root.left, level \+ 1, M);  
        swap\_child(root.right, level \+ 1, M);  
    }  
}  
